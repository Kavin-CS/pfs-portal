          ...
          <div>
            ...
            >
              ...
              {data.Type === KEY_USER_TYPE.parent && (
                <Grid item>
                  <IconButton
                    ...
                    onClick={handleMail}
                  >
                    <img src={MailIcon} alt="search" className={classes.icon} />
                  </IconButton>
                  <Popover
                    id="menu-appbar-mail"
                  ...
                  >
                    {/* <MenuItem onClick={handleMailClose}>Profile</MenuItem>
                    <MenuItem onClick={handleMailClose}>My account</MenuItem> */}
                      ...
                      config?.contacts
                        ...
                        .map(contact => (
                          ...
                          >
                            ...
                            {/* <Typography>{contact.mail}</Typography> */}
                          </MenuItem>
                        ))}
              ...
              {data.Type === KEY_USER_TYPE.parent && (
                <Grid item>
                  <Grid item container onClick={handleChangeChild}>
                    <Grid>
                      ...
                      <Typography variant="body1" className={classes.childName}>
                        {getChildName()}
                      </Typography>
                    </Grid>
                ...
                //   className={classes.actionButton}
                // >
                //   <KenToolTip icon={ChevronDownIcon} text={t('Change_Child')} />
                // </IconButton>
              )}
            </Grid>
